...
const WORDS = ["I am Sumit Barnawal", "I am a College Student", "I am Coder", "I am a Web Developer", "I am a Graphic Designer"];
const TECH_STACK = ["Code", "Create", "Eat", "Sleep"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/BarnawarSumit" },
  { icon: Linkedin, link: "https://x.com/Sumit_barnawal9?t=Wfc0NSmEyebAXI78H4hvvg&s=09" },
  { icon: Instagram, link: "https://www.instagram.com/itsbarnawal/" }
];
